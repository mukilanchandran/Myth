...
export const MODES = {
  ...
  business: { label: 'Business', color: '#0f766e', hint: 'Validate, plan, set up, brand, build, launch.' },
  website: { label: 'Website / app', color: '#12a150', hint: 'Research, content, design, build, test, launch.' },
